// main открывает соединение с базой данных, проверяет его, 
// выполняет начальное наполнение таблицы кошельков, 
// инициализирует репозиторий и API, настраивает руты, 
